...
class IPerfilUsuarioRepository(Protocol):
    ...
    async def crear(self, usuario_id: int, **datos: Any) -> PerfilUsuario: ...

    async def actualizar(self, usuario_id: int, **datos: Any) -> PerfilUsuario | None: ...
