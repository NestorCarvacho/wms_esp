...
import type { CreateEmployeeContractFormData } from '@/schemas/employee/employeeContractCreate.schema';
import {
...
interface CreateEmployeeContractFormProps {
  contractForm: {
    register: UseFormRegister<CreateEmployeeContractFormData>;
    setValue: UseFormSetValue<CreateEmployeeContractFormData>;
    watch: UseFormWatch<CreateEmployeeContractFormData>;
    errors: FieldErrors<CreateEmployeeContractFormData>;
    trigger: UseFormTrigger<CreateEmployeeContractFormData>;
  };
...
export const CreateEmployeeContractForm: React.FC<CreateEmployeeContractFormProps> = ({
  contractForm,
    ...
    <FormLayout onSubmit={handleSubmit} columns={4}>
      ...
      <FormLayout.Section title="Datos del contrato">
        ...
        <LabelInput
          ...
          value={normalizeWatchValueToString(contractForm.watch('contractName'))}
        ...
        <LabelInput
          ...
          required
          hasError={!!contractForm.errors.contractNumber}
          errorMessage={contractForm.errors.contractNumber?.message}
          value={normalizeWatchValueToString(contractForm.watch('contractNumber'))}
          onChange={(value: string) => contractForm.setValue('contractNumber', value, { shouldValidate: true })}
          variant="standard"
          placeholder={translate('employee:contracts.fields.contractNumberPlaceholder')}
        ...
        <DatePicker
          ...
          value={normalizeWatchValue(contractForm.watch('dateEntry'))}
        ...
        <DatePicker
          ...
          value={normalizeWatchValue(contractForm.watch('contractStartDate'))}
        ...
        <DatePicker
          ...
          value={normalizeWatchValue(contractForm.watch('contractEndDate'))}
      ...
      <FormLayout.Section title="Datos organizacionales">
        ...
        <Selector
          ...
          onChange={(value: string | string[]) => {
            const stringValue = normalizeSelectValue(value);
      ...
      <FormLayout.Footer
        cancelButton={
          <PrimaryButton type="button" variant="outline" onClick={onCancel} disabled={creating}>
            {translate('common:actions.cancel')}
          </PrimaryButton>
        }
        primaryButton={
          <PrimaryButton type="button" onClick={onSave} disabled={creating}>
            {creating ? translate('common:actions.saving') : translate('common:actions.save')}
          </PrimaryButton>
        }
      />
    </FormLayout>
...
export default CreateEmployeeContractForm;
