    ...
    <div className="fixed inset-0 z-[60] flex lg:hidden">
      ...
      >
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 p-4">
          <span className="text-sm font-semibold text-slate-600 dark:text-slate-300">Menú</span>
          <button
            type="button"
            onClick={() => handleClose(onClose)}
        ...
        <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 px-4 py-3">
          ...
          <h2 className="flex-1 text-sm font-medium text-slate-800 dark:text-slate-200">
